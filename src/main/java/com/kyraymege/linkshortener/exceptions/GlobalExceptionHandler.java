...
import com.kyraymege.linkshortener.models.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(LinkAPIException.class)
    public ResponseEntity<ErrorDetails> handleLinkAPIException(LinkAPIException exception, WebRequest webRequest){
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), exception.getMessage(), webRequest.getDescription(false));
